...
class MyProfilModel extends Model{
    ...
    {
        $sth = $this->db->prepare("SELECT first_name, last_name, email, dialing_code, phone_mobile, 
                                            address_street, address_postalcode, address_city, address_country, country_code,  
    ...
    public function setContactConnected($data)
    {
        ...
        $sth->bindParam(':dialing_code', $data['dialing_code'], PDO::PARAM_STR);
        ...
        $sth->bindParam(':country_code', $data['country_code'], PDO::PARAM_STR);
